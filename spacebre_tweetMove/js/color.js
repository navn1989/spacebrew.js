...
Color.lerp = function (a, b, time) {
    var result = new Color(a.r, a.g, a.b);

    result.r += (b.r - a.r)*time;
    result.g += (b.g - a.g)*time;
    result.b += (b.b - a.b)*time;

    return result;
}

Color._moveTowards = function(a, b, increase) {
    var diff = b-a,
...
Color.moveTowards = function(colorA, colorB, increase) {
    var result = new Color(0, 0, 0);

    result.r = Color._moveTowards(colorA.r, colorB.r, increase);
    result.g = Color._moveTowards(colorA.g, colorB.g, increase);
    result.b = Color._moveTowards(colorA.b, colorB.b, increase);
